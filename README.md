# E-Fluxus Tech Challenge for Backend Open Positions
...
Embora nossas aplicações sejam escritas C# (.net core), você não precisa escrever sua solução usando elas. Use a linguagem de programação que considera ter mais conhecimento.
